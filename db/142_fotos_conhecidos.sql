...
UPDATE entries SET image_url = 'https://commons.wikimedia.org/wiki/Special:FilePath/Miracolo_Eucaristico_di_Lanciano_-_foto_dal_vivo.JPG' WHERE title = 'Milagre Eucarístico de Lanciano' AND image_url IS NULL;
